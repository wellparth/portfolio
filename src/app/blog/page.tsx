...
export default function BlogIndexPage() {
  return (
    <div className="min-h-screen bg-beige-100 text-ink-900">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 pt-10 pb-16 space-y-8">
        {/* Back Link */}
        <div>
          <Link
            href="/"
        ...
        <div className="space-y-2 border-b border-beige-300 pb-6">
          ...
          <p className="text-sm text-ink-700 max-w-2xl">
            Writing on AI-assisted workflows, digital project coordination, and operational efficiency.
          </p>
        </div>
            ...
            >
              <div className="space-y-3">
                <div className="flex items-center justify-between text-xs text-ink-500">
                  <span className="px-2 py-0.5 rounded bg-olive-100 text-olive-700 font-medium border border-olive-200">
                    {post.category}
                  </span>
                ...
                <h2 className="text-lg font-bold text-ink-900 group-hover:text-olive-600 transition-colors leading-snug">
                  {post.title}
                </h2>
              ...
              <div className="pt-4 mt-4 border-t border-beige-200 flex items-center text-xs font-medium text-olive-600 group-hover:text-olive-700">
