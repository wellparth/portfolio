        ...
        {blogPosts.map((post) => (
          ...
          >
            <div className="space-y-3">
              ...
              <h3 className="text-base font-bold text-ink-900 group-hover:text-olive-600 transition-colors leading-snug">
                {post.title}
              </h3>
            ...
            <div className="pt-4 mt-2 border-t border-beige-200 flex items-center text-xs font-medium text-olive-600 group-hover:text-olive-700">
